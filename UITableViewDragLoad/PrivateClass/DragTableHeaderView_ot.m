...
- (id)initWithFrame:(CGRect)frame datePermanentStoreKey:(NSString *)datePermanentStoreKey
{
    ...
    {
        self.releaseText = NSLocalizedString(@"", @"");
        self.pullDownText = NSLocalizedString(@"", @"");
        self.loadingText = NSLocalizedString(@"", @"");
        self.dateFormatterText = @"";
        self.refreshDateFormatText = @"";
